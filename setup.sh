...
echo "     6. prompt-strategist              — Prompts: System instructions & CoT"
echo ""
echo "  Data & Search:"
...
echo "    14. config-validator               — Validate: Schema and drift detection"
echo "    15. deployment-procedures          — Safeguard: Go/No-Go and rollback"
echo ""
echo "  ML/AI:"
echo "    16. mlops-pipeline-architect       — ML Pipelines: Training automation"
echo "    17. mlops-engineer                 — ML Ops: RAG pipelines & LLM scaling"
echo ""
echo "  Operations:"
echo "    18. incident-response-specialist   — Command: Incident response"
echo "    19. documentation-architect        — Memorialize: Codebase manuals"
echo ""
