...
echo ""
echo "  Search & Data:"
echo "     7. embedding-strategist           — Search: Vector search and retrieval"
echo "     8. mcp-builder                    — Connect: Integrate data and tools"
echo ""
echo "  Frontend & UI:"
echo "     9. ui-craftsman                   — UI Craft: Intentional aesthetics"
echo "    10. ui-builder                     — UI Build: React & Next.js engine"
echo ""
echo "  Cloud & K8s:"
echo "    11. k8s-platform-architect         — Platform: Enterprise K8s & GitOps"
echo "    12. container-architect            — Artifact: Docker & image hardening"
echo ""
echo "  CI/CD & Ops:"
echo "    13. deployment-engineer            — Pipeline: CI/CD and GitOps"
echo "    14. mlops-pipeline-architect       — ML Pipelines: Training automation"
echo "    15. config-validator               — Validate: Schema and drift detection"
echo ""
echo "  Safety & SRE:"
echo "    16. deployment-procedures          — Safeguard: Go/No-Go and rollback"
echo "    17. incident-response-specialist   — Command: Incident response"
echo ""
echo "  Design & Record:"
echo "    18. architecture-decision-records  — Record: Capture decisions"
echo "    19. architect-review               — Review: Audit design and code"
echo "    20. documentation-architect        — Memorialize: Codebase manuals"
echo ""
