...
echo ""
echo "  Operations:"
echo "    15. incident-response-specialist   — Command: Incident response"
echo "    16. documentation-architect        — Memorialize: Codebase manuals"
echo "    17. architect-review               — Review: Audit design and code"
echo ""
