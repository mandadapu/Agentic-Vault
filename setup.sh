...
echo ""
echo "  Governance:"
echo "    19. toxic-skills-scanner            — Threat Scan: ToxicSkills taxonomy"
echo "    20. agent-security-hardener        — Security: Skill auditing & threat defense"
echo "    21. compliance-officer             — Compliance: GDPR, HIPAA, SOC2, audits"
echo "    22. architecture-decision-records  — Record: Capture decisions"
echo "    23. architect-review               — Review: Audit design and code"
echo "    24. documentation-architect        — Memorialize: Codebase manuals"
echo ""
