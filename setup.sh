...
echo ""
echo "  Design & Record:"
echo "    19. architecture-decision-records  — Record: Capture decisions"
echo "    20. architect-review               — Review: Audit design and code"
echo "    21. documentation-architect        — Memorialize: Codebase manuals"
echo ""
