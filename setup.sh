...
echo ""
echo "  Governance:"
echo "    19. compliance-officer             — Compliance: GDPR, HIPAA, SOC2, audits"
echo "    20. architecture-decision-records  — Record: Capture decisions"
echo "    21. architect-review               — Review: Audit design and code"
echo "    22. documentation-architect        — Memorialize: Codebase manuals"
echo ""
