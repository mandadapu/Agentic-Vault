...
echo "  CLI:     npx agentic-vault --help"
echo ""
echo "  Next steps:"
echo "    npx agentic-vault install --claude   # Install to Claude Code"
echo "    npx agentic-vault install --cursor   # Install to Cursor"
echo "    npm run validate                            # Validate all skills"
echo ""
echo "  The Vault (26 Skills) — Security-Hardened with ToxicSkills Taxonomy"
echo ""
...
echo "      skill-audit                      — Static security analysis"
echo "      hydra-security-loop              — Adversarial red-teaming loop"
